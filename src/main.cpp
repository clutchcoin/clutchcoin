...
const string strMessageMagic = "ClutchCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 14 * 24 * 60 * 60; // ClutchCoin: 14 days
static const int64 nTargetSpacing = 600; // ClutchCoin: 10 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal clutchcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ClutchCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xdc0471923ab828e4d737227dd05b31fc3d3e53d6abbad452878785f90e5f6a98");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "November 25th, 2013 17:49 EST";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1385419696; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1385419696;
            block.nNonce   = 214021;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xae63ccb4fb389e1ee5836749bd3d9896cfa5330131574cd4bc4b71063a05fd73"));
